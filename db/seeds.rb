...
Project.create({title: 'Anatomy Park', description: 'Help us fund the worlds premier new theme park', details: "fill me in later",  end_date: DateTime.now(), funding_goal: 50000, creator_id: 1, category: 'Theatre'})
