...
Project.create!({title: 'Anatomy Park', image: File.open("app/assets/images/Anatomy_Park.png"), description: 'Help us fund the worlds premier new theme park', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 10000, creator_id: users[0].id, category: 'Theatre'})
Project.create!({title: 'Help me take 2 strokes off my golf swing', image: File.open("app/assets/images/golf.png"), description: 'how hard can it be?', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 3000, creator_id: users[3].id, category: 'Games'})
Project.create!({title: 'Fund a new laboratory', image: File.open("app/assets/images/lab.png"), description: 'A new top of the line lab for inventions ', details: ipsum,  end_date: "30 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 4500, creator_id: users[0].id, category: 'Design'})
Project.create!({title: 'New basketball hoop for the park', image: File.open("app/assets/images/basketball.png"), description: 'A newly renovated basketball hoop for the park', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 2345, creator_id: users[2].id, category: 'Games'})
Project.create!({title: 'Counsel of Ricks', image: File.open("app/assets/images/CofRs.png"), description: 'The Ricks need your Help', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, creator_id: users[0].id, category: 'Theatre'})
Project.create!({title: 'Fund a new local saloon', image: File.open("app/assets/images/saloon.png"), description: 'A new saloon could be right in your backyard!', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 20000, creator_id: users[2].id, category: 'Food'})
Project.create!({title: 'Meseeks Box', image: File.open("app/assets/images/meseeks.png"), description: 'A phenomenal new product to help you with everyday tasks', details: ipsum,  end_date: "5 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 40000, creator_id: users[4].id, category: 'Technology'})
Project.create!({title: 'Robot Dog Technology', image: File.open("app/assets/images/robodog.png"), description: 'The first of its kind in dog mech suits', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 6500, creator_id: users[0].id, category: 'Technology'})
Project.create!({title: 'Block Party!', image: File.open("app/assets/images/party.png"), description: 'help us fund an annual block party at the park', details: ipsum,  end_date: "15 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 45000, creator_id: users[0].id, category: 'Theatre'})
Project.create!({title: 'Show me what you got', image: File.open("app/assets/images/moonguy.png"), description: 'Pease hire me', details: ipsum,  end_date: "27 Jul 2017 09:54:17 -0400", funding_goal: 50000, current_funding: 28000, creator_id: users[1].id, category: 'Technology'})
